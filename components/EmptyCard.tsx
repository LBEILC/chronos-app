    ...
    >
      <div 
        className={`
          ...
          bg-[#262626] 
          rounded-lg
          border-4 border-dashed border-[#444]
          overflow-hidden
      ...
      >
        ...
        {/* Label area */}
        <div className="absolute top-0 left-0 right-0 h-16 border-b-4 border-[#333] bg-[#1a1a1a] flex items-center px-6 shadow-md">
           <div className="w-full h-4 bg-[#333] rounded-sm animate-pulse" />
        </div>
      </div>
    </div>
  );

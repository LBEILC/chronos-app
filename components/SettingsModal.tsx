...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 z-[200] flex items-center justify-center p-4 ${isClosing ? 'pointer-events-none' : ''}`}>
      ...
      {/* Settings Window */}
      <div className={`relative w-full max-w-md bg-[#1a1a1a] border-4 border-[#333] shadow-[8px_8px_0px_rgba(0,0,0,1)] ${isClosing ? 'animate-slide-down-out' : 'animate-slide-up'} overflow-hidden flex flex-col max-h-[90vh]`}>
